...
const MyProfile = () => {
  ...
  return userData ? (
    <div className="max-w-lg mx-auto flex flex-col gap-4 text-sm pt-8 bg-gray-100 p-6 rounded-2xl shadow-md">
      <div className="flex flex-col items-center">
        {isEdit ? (
          <label htmlFor="image" className="cursor-pointer relative group">
            <img
              className="w-36 h-36 rounded-full object-cover border-2 border-gray-300 group-hover:opacity-75"
      ...
      {isEdit ? (
        <input
          className="bg-gray-200 text-3xl font-semibold text-center p-2 rounded-md focus:outline-none"
          type="text"
          onChange={(e) =>
      ...
      <div className="mt-10 flex justify-center">
        {isEdit ? (
          <button
            ...
            className="px-8 py-2 border border-black text-black rounded-full hover:bg-black hover:text-white transition-all"
          >
            Save information
          </button>
        ) : (
